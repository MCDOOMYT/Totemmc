...
const config = {
    serverInfo: {
        serverLogoImageFileName: "logo1.png",
        /*This is a file name for logo in /images/ (If you upload new logo with other name, you must change this value)*/
        serverName: "TotemMC",
        /*Server name*/
        serverIp: "play.totemmc.fun",
        ...
        discordServerID: "1205507639329689641" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    <nameOfGroup>: [
        {
            inGameName: "GreenArrow99",
            rank: "Owner",
            skinUrlOrPathToFile: "https://cdn.discordapp.com/attachments/1119547221831057468/1120275928573026364/e7d109466b6e8fed.png",
            rankColor: ""
        },
    ]
    ...
    */
    ...
    /*[full, bust, head, face, front, frontFull, skin]*/
    ...
    adminTeamPage: {
        ...
        developers: [
            /* {
                 inGameName: "Perpltxed",
                 rank: "Developer",
                 skinUrlOrPathToFile: "",
                 rankColor: ""
             },*/
            {
                inGameName: "ItsNeil_1711",
                rank: "Sys Admin",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
        ...
        staff: [{
            ...
            {
                inGameName: "StarGamingYT",
                rank: "Helper",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
            {
                inGameName: "Lightningmanzs",
                rank: "Helper",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
    ...
    */
    contactPage: {
        email: "10f9c00aac7ed132f03666428ffbad59"
    }
}
